package day05aArithmeticOperators;

public class EmployeeInfo { /*    1. create a class named EmployeeInfo
    ...
    public static void main(String[]args){
        ...
        System.out.println(firstName+" "+lastName+"' JobsTitle is: "+ jobTitle);
